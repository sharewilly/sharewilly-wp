...
function sharewilly_plugin_action_links( $links ) {
   $links[] = '<a href="'. esc_url( get_admin_url(null, 'admin.php?page=sharewilly_fields') ) .'">Einstellungen</a>';
...
require 'includes/sharewilly-update-checker/sharewilly-update-checker.php';
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://sharewilly.de/sharewilly-update-checker/sharewilly.json',
	__FILE__,
	'Sharewilly_Wp'
);
